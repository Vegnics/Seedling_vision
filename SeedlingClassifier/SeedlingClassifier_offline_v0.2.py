...
kernel = highpass_butterworth_kernel(270,840,0.65,1.0,38,2)
...
## OPEN MODELS
file = open("../segmentation/clustering_with_preproc/MLmodel_v0.2.pkl", "rb")
...
rgb_roi = preprocess(rgb_roi,kernel,reference) ## NEW LINE ADDED
...
S0,S1,S2 = assign_to_seedling(mask,contours,hierar,depth_orig,hole_positions,3.8,seedlingParity,intrinsics)
