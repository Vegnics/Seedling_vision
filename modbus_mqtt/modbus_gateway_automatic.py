...
class modbusApp(tk.Tk):
    ...
    def checkPLCInstruction(self):
        ...
        if plcInstruction == lsmodb.PLC_NOORDER_INST:
            ...
            sleep(2)
            self.client.writeSeedling1Quality(randint(0,3))
            sleep(0.1)
            self.client.writeSeedling2Quality(randint(0,3))
            sleep(0.1)
            self.client.writeSeedling3Quality(randint(0,3))
            sleep(0.1)
            self.client.writeZcorrection(np.float32(triangular(-20,20)),np.float32(triangular(-20,20)),np.float32(triangular(-20,20)))
            sleep(0.1)
            ...
            #self.client.cvFinishProcessing()
